export default function InfoDetail() {
  return (
    <div>
      <h1 className="font-mono text-[36px]">Here is my portfolio</h1>
      <br />
      <p className="font-mono text-[28px] font-bold">
        - Fullname: Phạm Quang Huy.
      </p>
      <p className="font-mono text-[28px] font-bold">DOB: 10/06/1999.</p>
      <p className="font-mono text-[28px] font-bold">
